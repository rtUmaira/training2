 ...
 * PLACE ANY CUSTOMIZATIONS IN sch_Teachers
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class sch_Teachers_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'sch_Teachers';
    public $object_name = 'sch_Teachers';
    public $table_name = 'sch_teachers';
     ...
     * @deprecated
     */
    public function sch_Teachers_sugar(){
        $GLOBALS['log']->deprecated('Calls to sch_Teachers::sch_Teachers are deprecated.');
        self::__construct();
    }
