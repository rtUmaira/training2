 ...
 * PLACE ANY CUSTOMIZATIONS IN sch_Students
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class sch_Students_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'sch_Students';
    public $object_name = 'sch_Students';
    public $table_name = 'sch_students';
     ...
     * @deprecated
     */
    public function sch_Students_sugar(){
        $GLOBALS['log']->deprecated('Calls to sch_Students::sch_Students are deprecated.');
        self::__construct();
    }
