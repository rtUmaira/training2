 ...
 * PLACE ANY CUSTOMIZATIONS IN sch_Schools
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class sch_Schools_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'sch_Schools';
    public $object_name = 'sch_Schools';
    public $table_name = 'sch_schools';
     ...
     * @deprecated
     */
    public function sch_Schools_sugar(){
        $GLOBALS['log']->deprecated('Calls to sch_Schools::sch_Schools are deprecated.');
        self::__construct();
    }
